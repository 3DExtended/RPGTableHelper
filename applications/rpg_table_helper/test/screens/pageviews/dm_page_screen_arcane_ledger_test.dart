...
/// iPad-landscape goldens for all DM pageview screens under Arcane Ledger.
...
void main() {
  ...
  group('arcane ledger dmpagescreens', () {
    ...
    for (final testcase in testCases) {
      testConfigurations(
        ...
        widgetName:
            'arcane-ledger-dmpagescreens${testcase.$1}-${testcase.$2}',
