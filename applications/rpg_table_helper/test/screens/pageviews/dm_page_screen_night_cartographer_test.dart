...
/// iPad-landscape goldens for all DM pageview screens under Night Cartographer.
...
void main() {
  ...
  group('night cartographer dmpagescreens', () {
    ...
    for (final testcase in testCases) {
      testConfigurations(
        ...
        widgetName:
            'night-cartographer-dmpagescreens${testcase.$1}-${testcase.$2}',
