  ...
  group('RpgConfigurationModel tests', () {
    test('RpgConfigurationModel - json serializes correctly', () {
      ...
      final model = RpgConfigurationModel(
          ...
          itemCategories: [
            ItemCategory(uuid: "0", name: "Kleidung", subCategories: [
              ItemCategory(uuid: "01", name: "Rüstung", subCategories: null),
              ItemCategory(uuid: "02", name: "Accessoire", subCategories: null),
            ]),
            ItemCategory(uuid: "6", name: "Zutaten", subCategories: null),
            ItemCategory(uuid: "1", name: "Trank", subCategories: [
              ItemCategory(uuid: "11", name: "Heilung", subCategories: null),
              ItemCategory(uuid: "12", name: "Gift", subCategories: null),
              ItemCategory(uuid: "13", name: "Gegengift", subCategories: null),
              ItemCategory(uuid: "14", name: "Buff", subCategories: null),
            ]),
            ItemCategory(uuid: "2", name: "Waffen", subCategories: [
              ItemCategory(uuid: "21", name: "Finesse", subCategories: null),
              ItemCategory(uuid: "22", name: "Fernkampf", subCategories: null),
              ItemCategory(uuid: "23", name: "Magie", subCategories: null),
              ItemCategory(uuid: "24", name: "Wurfwaffe", subCategories: null),
            ]),
            ItemCategory(uuid: "3", name: "Schätze", subCategories: null),
            ItemCategory(uuid: "4", name: "Tools", subCategories: null),
            ItemCategory(uuid: "5", name: "Sonstiges", subCategories: null),
          ],
          placesOfFindings: [
      ...
      expect(serializedText,
          '{"rpgName":"DnD - Marie config","allItems":[{"uuid":"asdf","name":"Ascheveilchen","categoryId":"6","placeOfFindingIds":["wald","berg"],"baseCurrencyPrice":20000},{"uuid":"asdfew","name":"Aloe Vera","categoryId":"6","placeOfFindingIds":["savanne","wüste","steppe"],"baseCurrencyPrice":200300},{"uuid":"asdeefew","name":"Aurora Rose","categoryId":"6","placeOfFindingIds":["wald","berg","grasland"],"baseCurrencyPrice":2300},{"uuid":"asde323efew","name":"Roter Amanita Pilz","categoryId":"6","placeOfFindingIds":["wald","sümpfe","höhle"],"baseCurrencyPrice":232100},{"uuid":"Lebenslikörasdf","name":"Lebenslikör","categoryId":"11","placeOfFindingIds":null,"baseCurrencyPrice":232133300}],"placesOfFindings":[{"uuid":"wald","name":"Wald"},{"uuid":"grasland","name":"Grasland"},{"uuid":"berg","name":"Berg"},{"uuid":"steppe","name":"Steppe"},{"uuid":"wüste","name":"Wüste"},{"uuid":"savanne","name":"Savanne"},{"uuid":"sümpfe","name":"Sümpfe"},{"uuid":"höhle","name":"Höhle"}],"itemCategories":[{"uuid":"0","name":"Kleidung","subCategories":[{"uuid":"01","name":"Rüstung","subCategories":null,"hideInInventoryFilters":false},{"uuid":"02","name":"Accessoire","subCategories":null,"hideInInventoryFilters":false}],"hideInInventoryFilters":false},{"uuid":"6","name":"Zutaten","subCategories":null,"hideInInventoryFilters":false},{"uuid":"1","name":"Trank","subCategories":[{"uuid":"11","name":"Heilung","subCategories":null,"hideInInventoryFilters":false},{"uuid":"12","name":"Gift","subCategories":null,"hideInInventoryFilters":false},{"uuid":"13","name":"Gegengift","subCategories":null,"hideInInventoryFilters":false},{"uuid":"14","name":"Buff","subCategories":null,"hideInInventoryFilters":false}],"hideInInventoryFilters":false},{"uuid":"2","name":"Waffen","subCategories":[{"uuid":"21","name":"Finesse","subCategories":null,"hideInInventoryFilters":false},{"uuid":"22","name":"Fernkampf","subCategories":null,"hideInInventoryFilters":false},{"uuid":"23","name":"Magie","subCategories":null,"hideInInventoryFilters":false},{"uuid":"24","name":"Wurfwaffe","subCategories":null,"hideInInventoryFilters":false}],"hideInInventoryFilters":false},{"uuid":"3","name":"Schätze","subCategories":null,"hideInInventoryFilters":false},{"uuid":"4","name":"Tools","subCategories":null,"hideInInventoryFilters":false},{"uuid":"5","name":"Sonstiges","subCategories":null,"hideInInventoryFilters":false}],"characterStatsDefinition":{"mainPlayerStat":{"name":"HP","statUuid":"5251c0bb-02ee-405b-b697-8e6ff0482983","helperText":"Lebenspunkte","valueType":"intWithMaxValue","editType":"oneTap"},"secondaryPlayerStat":{"name":"AC","statUuid":"d728a934-6b3d-4548-9fe9-53a42e88712b","helperText":"Rüstungsklasse","valueType":"int","editType":"static"},"thirdPlayerStat":{"name":"SP","statUuid":"8882935f-a3e8-42b3-9b38-0d87aa71df73","helperText":"Geschwindigkeit","valueType":"int","editType":"static"},"otherPlayerStats":[{"name":"Class","statUuid":"9ff51b8e-59a2-427f-8236-3ab6933ded5b","helperText":"The main class of your character.","valueType":"string","editType":"static"}]},"craftingRecipes":[{"recipeUuid":"123456789087654321","ingredients":[{"itemUuid":"asdfew","amountOfUsedItem":1},{"itemUuid":"asdeefew","amountOfUsedItem":1},{"itemUuid":"asde323efew","amountOfUsedItem":1}],"createdItem":{"itemUuid":"Lebenslikörasdf","amountOfUsedItem":1}}],"currencyDefinition":{"currencyTypes":[{"name":"Kupfer","multipleOfPreviousValue":null},{"name":"Silber","multipleOfPreviousValue":10},{"name":"Gold","multipleOfPreviousValue":10},{"name":"Platin","multipleOfPreviousValue":10}]}}');
    });
  });
}
