...
// ignoring this issue as i am using the internal implementations of
// sign_in_with_apple which is necessary as i want to be able to style
// this button individually
...
class CustomSignInWithAppleButton extends StatelessWidget {
  const CustomSignInWithAppleButton({
    super.key,
    required this.onPressed,
    this.text = 'Sign in with Apple',
    this.fontSize = 19,
    this.height = 44,
    this.style = CustomSignInWithAppleButtonStyle.black,
  ...
  ///
  /// This defaults to [CustomSignInWithAppleButtonStyle.black].
  final CustomSignInWithAppleButtonStyle style;
  ...
  Color get _backgroundColor {
    switch (style) {
      case CustomSignInWithAppleButtonStyle.black:
        return Colors.black;
      case CustomSignInWithAppleButtonStyle.white:
      case CustomSignInWithAppleButtonStyle.whiteOutlined:
        return Colors.white;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final textWidget = Text(
      ...
      //  I am allowed to customize the apple sign in button like stated here:
...
///
/// https://developer.apple.com/design/human-interface-guidelines/sign-in-with-apple/overview/buttons/
enum CustomSignInWithAppleButtonStyle {
...
/// This controls the alignment of the Apple Logo on the [CustomSignInWithAppleButton]
enum IconAlignment {
