...
namespace RPGTableHelper.WebApi.Services
{
    public class UserContextProvider : IUserContext
    {
        ...
        )
        {
            ...
            {
                throw new NullReferenceException("The usercontext could not resolve the httpcontext");
            }
            ...
            var userId = DataLayer.Contracts.Models.Auth.User.UserIdentifier.From(Guid.Parse(identityProviderId));
            ...
            User = new UserIdentity { Username = usernameClaim.Value, IdentityProviderId = identityProviderId };
        }
