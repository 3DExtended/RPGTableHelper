...
namespace RPGTableHelper.DataLayer.Migrations
{
    ...
    [Migration("20260725221516_AddAuthSessions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RPGTableHelper.DataLayer.Entities.AuthSessionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTimeOffset?>("PreviousTokenExpiresAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RPGTableHelper.DataLayer.Entities.RpgEntities.CampagneEntity", b =>
                {
                    ...
                    b.Property<string>("RpgConfigurationCold")
                        .HasColumnType("TEXT");

                    b.Property<int>("RpgConfigurationColdRevision")
                        .HasColumnType("INTEGER");

                    b.Property<string>("RpgConfigurationHot")
                        .HasColumnType("TEXT");

                    b.Property<int>("RpgConfigurationHotRevision")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RpgConfigurationMergedRevision")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("RpgConfigurationSchemaVersion")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RPGTableHelper.DataLayer.Entities.RpgEntities.CampagneRpgConfigHistoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CampagneId", "Revision")
                        .IsUnique();

                    b.ToTable("CampagneRpgConfigHistories");
                });
            ...
            modelBuilder.Entity("RPGTableHelper.DataLayer.Entities.RpgEntities.PlayerCharacterEntity", b =>
                {
                    ...
                    b.Property<int>("RpgCharacterConfigurationRevision")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RPGTableHelper.DataLayer.Entities.RpgEntities.PlayerCharacterRpgConfigHistoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("PlayerCharacterId", "Revision")
                        .IsUnique();

                    b.ToTable("PlayerCharacterRpgConfigHistories");
                });
            ...
            modelBuilder.Entity("RPGTableHelper.DataLayer.Entities.RpgEntities.PlayerCharacterRpgConfigHistoryEntity", b =>
                {
                    b.HasOne("RPGTableHelper.DataLayer.Entities.RpgEntities.PlayerCharacterEntity", "PlayerCharacter")
                        .WithMany()
